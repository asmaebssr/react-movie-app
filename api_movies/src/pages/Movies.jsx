...
const handlePages = () =>
  ...
  return (
    <div >
    <h1 className="font-bold text-gray-800 text-center text-4xl">Movies</h1>
    ...
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 p-4">
      {movies && movies.map((movie) => (
        ...
        >
          ...
          />
          <h3 className="text-center p-4 font-bold text-lg text-gray-800">{movie.title? movie.title : "No title found"}</h3>
          <h4 className="text-center pb-2 font-semibold text-gray-600">Movie  <span className="text-gray-400 italic">({movie.release_date? movie.release_date : "No release date found"})</span></h4>
